        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'editproflie',
              path: 'editproflie',
              builder: (context, params) => EditproflieWidget(),
            ),
            FFRoute(
              name: 'Signinpage',
              path: 'signinpage',
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'announcement')
                  : AnnouncementWidget(),
            ),
            FFRoute(
              name: 'search',
            ...
            FFRoute(
              ...
              path: 'portal',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'portal')
                  : PortalWidget(),
            ),
            FFRoute(
              name: 'DepartmentPoortal',
              path: 'departmentPoortal',
              builder: (context, params) => DepartmentPoortalWidget(),
            ),
            FFRoute(
              name: 'students',
              path: 'students',
            ...
            FFRoute(
              name: 'Professor',
              path: 'professor',
              builder: (context, params) => ProfessorWidget(),
            ),
            FFRoute(
              name: 'documents',
              path: 'documents',
